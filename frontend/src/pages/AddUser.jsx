            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="col-span-2 border-t pt-4 mt-2">
                    <h3 className="text-sm font-bold text-gray-700 mb-4">Incentive & Commission Structure</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            >
                                ...
                                <option value="commission">Pure Commission Base</option>
                            ...
                            <div className="animate-in fade-in slide-in-from-left-2 transition-all">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={handleChange}
                                        step="0.01"
                                        className="w-full px-4 py-2 border border-blue-300 bg-blue-50/30 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                ...
                                <p className="text-[10px] text-gray-500 mt-1">Calculated based on total revenue generated by the employee.</p>
                            </div>
                        )}
                    </div>
                </div>
