  ...
  const fetchCompanyDetails = async () => {
    try {
      ...
      if (response.data?.success && response.data?.data) {
        ...
        if (company.logo) setLogoPreview(resolveUrl(company.logo));
        if (company.favicon) setFaviconPreview(resolveUrl(company.favicon));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const companyData = {
        ...
        default_punch_out_time: companyForm.default_punch_out_time,
      ...
      // Also update theme settings in context for immediate UI feedback
