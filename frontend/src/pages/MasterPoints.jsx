    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="bg-white rounded-lg shadow p-4">
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center p-10 h-48 animate-in fade-in duration-500">
                        <LogoLoader text={`Loading ${TABS.find(t => t.id === activeTab)?.label.toLowerCase()}...`} />
                    </div>
                ) : (
