                  ...
                  <tr key={company.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-blue-600 font-mono">
                        {company.crm_url ? company.crm_url.replace('https://', '') : `crmopp.${company.subdomain}${company.domain ? '.' + company.domain.split('.').slice(-2).join('.') : ''}`}
                      </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <a
                        href={company.crm_url || `https://crmopp.${company.subdomain}.${company.domain}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm text-blue-600 hover:text-blue-800 hover:underline flex items-center gap-1"
                      >
                        {company.crm_url ? company.crm_url.replace('https://', '') : `crmopp.${company.subdomain}.${company.domain}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600 mt-1 font-semibold">
                    CRM URL will be: crmopp.{formData.domain || 'domain.com'}
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-blue-600 font-mono">
                    {selectedCompany.crm_url ? selectedCompany.crm_url.replace('https://', '') : `crmopp.${selectedCompany.subdomain}.${selectedCompany.domain}`}
                  </p>
                </div>
                <div>
