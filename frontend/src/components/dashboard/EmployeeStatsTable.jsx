...
const EmployeeStatsTable = ({ data = [], loading = false }) => {
        ...
        return (
            <div className="bg-[#F4F6FF] rounded-xl p-4 w-full h-full flex flex-col">
                <h2 className="text-[16px] font-semibold text-gray-900 mb-4">
                    Employee <span className="text-red-500">Performance</span>
                </h2>
        ...
        <div className="bg-[#F4F6FF] rounded-xl p-4 w-full h-full flex flex-col">
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-[16px] font-semibold text-gray-900">
                    Employee <span className="text-red-500">Stats</span>
                </h2>
            </div>

            <div className="grid grid-cols-[30px_1fr_45px_45px_45px_60px] gap-2 px-3 py-2 text-[10px] font-semibold text-gray-500 uppercase tracking-wider">
