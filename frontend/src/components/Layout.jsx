...
import { settingsAPI, menuAPI, notificationsAPI } from '../services/api';
...
const Layout = ({ children, Header, padding = 0 }) => {
  ...
  const GlobalHeader = () => {
    ...
    const handleNotifClick = () => setIsNotifDropdownOpen(!isNotifDropdownOpen);
    ...
    useEffect(() => {
      const handleClickOutside = (event) => {
        if (isNotifDropdownOpen && !event.target.closest('.notif-dropdown')) {
          setIsNotifDropdownOpen(false);
        }
      };
      document.addEventListener('mousedown', handleClickOutside);
    ...
    return (
      <div
        className={`header-bar sticky top-0 z-50 w-full
px-3 sm:px-4 lg:px-6
py-2 lg:py-3
min-h-14 lg:min-h-16 lg:h-16
transition-all duration-300 border-b border-gray-200/50 shadow-sm`}
          ...
          <div className="flex flex-wrap items-center justify-between sm:justify-end gap-2">
            ...
            <div className="relative notif-dropdown">
              <button
                ...
                className="p-2 text-gray-700 hover:bg-gray-400 rounded-lg relative"
              >
                    ...
                    {notifications.filter(n => !n.is_read).length === 0 ? (
                      ...
                      notifications.filter(n => !n.is_read).map(n => (
                        <div
                          ...
                          className="p-3 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors bg-blue-50/50"
                        >
    ...
    <div className="min-h-screen relative" style={{ backgroundColor: bgColor }}>
      ...
      >
        ...
        <div className="custom-scroll" style={{ backgroundColor: bgColor }}>
          ...
          {Header && (
            <div className="sticky top-[56px] lg:top-[64px] z-40 bg-white" style={{ padding: `${padding}px ${padding}px 0px ${padding}px` }}>
              <Header />
            </div>
          )}
