...
Route::middleware('auth:sanctum')->prefix('marketing')->group(function () {
    ...
    // SMS Campaigns
    Route::middleware('plan.feature:sms_campaigns')->group(function () {
    ...
    // Marketing Templates
    Route::middleware('plan.feature:email_templates')->group(function () {
    ...
    Route::middleware('plan.feature:social_media')->group(function () {
    ...
    Route::middleware('plan.feature:marketing_automation')->group(function () {
    ...
    // A/B Testing
    Route::middleware('plan.feature:ab_testing')->group(function () {
    ...
    // Landing Pages
    Route::middleware('plan.feature:landing_pages')->group(function () {
